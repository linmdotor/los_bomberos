...
Contiene la declaración de la clase que encapsula el parseo de mapas en xml.

@see Map::MapParserXml

@author Daniel Parra López
@date Diciembre, 2015
*/


#ifndef __Map_ParserXml_H
#define __Map_ParserXml_H
...
namespace Map {
	...
	/**
	La clase MapParserXml reune todos los componentes necesarios para el parseo
...
Map = {
	...
	*/
	...
	public:
		...
		/**
		Devuelve la única instancia de la clase MapParserXml.
		
		@return Única instancia de la clase MapParserXml.
		*/
		static MapParserXml* getSingletonPtr() { return _instance; }
